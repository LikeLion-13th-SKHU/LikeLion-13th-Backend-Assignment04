...
@Getter
@AllArgsConstructor(access = AccessLevel.PRIVATE) // JPA에 의해 관리 되지 않기 때문에 private
public enum ErrorCode {

    // 404 NOT_FOUND
    MEMBER_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 사용자가 없습니다. memberId = ", "NOT_FOUND_404"),
    REVIEW_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 리뷰가 없습니다. postId = ", "NOT_FOUND_404"),
